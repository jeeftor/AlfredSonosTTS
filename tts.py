...
def main(wf):
	...
	if valid_setup:
		...
		wf.add_item('Change Voice','Select this option to pick a different voice', arg='config::SelectVoice', valid=True )
		wf.add_item('Change Speaker','Select this option to use a different Sonos Speaker', arg='config::SelectSpeaker', valid=True )
